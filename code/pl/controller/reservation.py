...
class ReservationController:
    ...
    def finish(reservation_service_mapper:ReservationService, table_mapper:ITableMapper,
               reservation_mapper: IReservationMapper) -> str:
        """
        ...
        success = reservation_service_mapper.add_reservation(dtime, table_id, table_mapper, reservation_mapper)
